...
<pre>(:dependencies [com.ashafa/clutch "0.2.5-SNAPSHOT"])</pre>
...
Once you have a working exec string, you can use Clojure for views and filters by adding it to the 'local.ini' file of your CouchDB installation:
